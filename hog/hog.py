...
def roll_dice(num_rolls, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    sum = 0
    # Determine whether to roll the die to 1
    ok = 1
    while num_rolls > 0:
        num = dice()
        if num == 1:
...
def swine_align(player_score, opponent_score):
    ...
    while ( opponent_score != 0):
        temp = player_score % opponent_score
        player_score = opponent_score
        opponent_score = temp
    if player_score >= 10:
        return True
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score1 < goal and score0 < goal:
        ...
        if who == 0:
            while take_cnt == 1:
                if score0 >= goal and extra_cnt > 0:
            ...
            while take_cnt == 1:
                if score1 >= goal and extra_cnt > 0:
                    return score0, score1
